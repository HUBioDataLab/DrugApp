...
#Data:
df=pd.read_csv(r"..\dataset\drug_indication\{0}_app_unapp_drug_indication.csv".format(sys.argv[1]),sep=',')
...
df_test=pd.read_csv(r"..\dataset\to_be_predicted\{0}_to_be_predicted.csv".format(sys.argv[1]),sep=',')
