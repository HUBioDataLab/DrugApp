...
#Data:
df=pd.read_csv(r"..\datasets\raw_datasets\{0}_app_unapp_drug_indication.csv".format(sys.argv[1]),sep=',')
...
df_test=pd.read_csv(r"..\datasets\prospective_analysis_datasets\{0}_to_be_predicted.csv".format(sys.argv[1]),sep=',')
